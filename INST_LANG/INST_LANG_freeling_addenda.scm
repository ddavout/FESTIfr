; /home/dop7/MyDevelop/FESTIfr/INST_LANG/INST_LANG_freeling_addenda.scm
...
(lex.add.entry '("url" ((NOM 0))()))
(lex.add.entry '("d_url" ((NOM 0))()))
(lex.add.entry '("l_url" ((NOM 0))()))

; ; TODO check  bug poslex utf8 non compatible vanilla festival
(lex.add.entry '("Àverell" ((NAM 0))())); juste pour test utf8 non compatible vanilla festival
...
(lex.add.entry '("Ça" ((PRO:dem 0))()))
(lex.add.entry '("çà" ((ADV 0))()))

; les homographes gérés via tokenpos
(lex.add.entry '("fier_ﬂ_ADJ" ((ADJ 0))()))
(lex.add.entry '("maintenant_ﬂ_ADV" ((ADV 0.001))()))
(lex.add.entry '("fils_ﬂ_fil" ((NOM 0))()))
(lex.add.entry '("fils_ﬂ_nil" ((NOM 0))()))

; les locutions 
;; tous les mots avec majuscule avant de savoir les ranger dans le poslex: INST_LANG_freeling_poslex
;; TODO check si une entrée de INST_LANG_freeling_addenda.scm existe avec ou sans majuscule, elle fait foi
; 


(lex.add.entry '("nuit_et_jour" ((ADV 0))()))

...
(lex.add.entry '("y" ( ( ADV -4.953) ( PRO:per -5.953) )()))               
(lex.add.entry '("y_" ( ( ADV -4.953) ( PRO:per -5.953) )())) ; artifice addenda sans liaison ; TODO compléter; vérifier         
(lex.add.entry '("y_a" ( ( AUX -1.000) ( VER -1.000) )()))                 
(lex.add.entry '("y_a_t_il" ( ( VER -1.000) ( AUX -1.000) )()))                 
(lex.add.entry '("y_avait" ( ( AUX -1.000) ( VER -1.000) )()))                 
(lex.add.entry '("y_en" ( ( ADV -4.953) ( PRO:per -5.953) )())) ;  

(lex.add.entry '("elle" ( ( PRO:per -1.536) )())) 
;(lex.add.entry '("elle_" ( ( PRO:per -1.536) )())) ; neut                   
(lex.add.entry '("elle_même" ( ( PRO:per -3.949) )())) 
(lex.add.entry '("elle_mêmes" ( ( PRO:per -3.949) )())) 
(lex.add.entry '("elles" ( ( PRO:per -2.570) )())) 
(lex.add.entry '("elles_mêmes" ( ( PRO:per -4.909) )())) 

(lex.add.entry '("z" ( ( NOM -3.988) )())) 
; ( "z_a" ( ( VER 0) )()) 
...
(lex.add.entry '("m_en" ( ( PRO:per 0) )()))                    
(lex.add.entry '("m_y" ( ( PRO:per -2.912) )())) 
(lex.add.entry '("t_en" ( ( PRO:per 0) )()))
(lex.add.entry '("t_à" ( ( PRE -0.804) )())) ; addenda neut_parl_s06_0669       
(lex.add.entry '("n_en" (( ADV -2.384))()))                    
(lex.add.entry '("n_es" (( VER -2.384))())) ; neut_book_s01_0006                   
(lex.add.entry '("n_est" (( VER -2.384))())) 
(lex.add.entry '("n_est_pas" (( VER -2.384))()))                    
(lex.add.entry '("n_importe_comment" (( ADV 0))())) 
(lex.add.entry '("n_importe_où" (( ADV 0))()))
(lex.add.entry '("n_importe_quel" (( ART:ind 0))()))
(lex.add.entry '("n_importe_quelle" (( ART:ind 0))()))                    
(lex.add.entry '("n_importe_qui" (( PRO:ind 0))())) 
(lex.add.entry '("n_ont" (( AUX -1.401) ( VER -2.707))()))                 
(lex.add.entry '("n_y" (( ADV -4.000))()))     
(lex.add.entry '("n_y_a" (( AUX -1.000) ( VER -1.000))())) ; neut_book_s01_0119                
(lex.add.entry '("n_y_en" (( ADV -4.000))())) ;                    
...
(lex.add.entry '("et_hop" ( ( ONO -0.524) )())) 


; ( "_y" ( ( ADV -4.953) ( PRO:per -5.953) )()) ; artifice addenda sans liaison ; TODO compléter; vérifier         
; ( "a_" ( ( AUX -0.616) ( VER -1.569) )())         
; rien n'y fait        
(lex.add.entry '( "a-t_elle" ( ( AUX -0.616) ( VER -0.616) )()))
(lex.add.entry '( "a-t_il" ( ( AUX -0.516) ( VER -0.516) )()))    
; (lex.add.entry '( "a_t_on" ( ( AUX -0.516) ( VER -0.516) )())); ne suffit pas 
(lex.add.entry '( "a-t_on" ( ( AUX -0.516) ( VER -0.516) )()))    
...
; bug poslex
(lex.add.entry '("être" ((AUX -1.535)(NOM -3.230)(VER -2.212))()))
(lex.add.entry '("s_être" ((AUX -1.535)(NOM -3.230)(VER -2.212))()))
(lex.add.entry '("j_espère" ((VER -2.912))()))
(lex.add.entry '("d_autres" ((ADJ:ind -1.798)(PRO:ind -1.195))()))
;(lex.add.entry '("y_a_t_il" ((VER -1.000)(aux -1.000))()))
;(lex.add.entry '("y_a-t_il" ((VER -1.000)(aux -1.000))()))

; Segmentation fault neut_parl_s01_0190
;(lex.add.entry '("tout_autre" ((ADJ -6.666)(ADJ_ind -6.666))())) BUG !!!
...
(lex.add.entry '("Ameline" ((NAM 0))())) 
(lex.add.entry '("Amérique" ((NAM 0))())) 
...
(lex.add.entry '("Bettencourt" ((NAM 0))())) 
(lex.add.entry '("Bies" ((NAM 0))())) 
(lex.add.entry '("Bière" ((NAM 0))())) 
...
(lex.add.entry '("Bur" ((NAM 0))()))
(lex.add.entry '("Burkina" ((NAM 0))()))
(lex.add.entry '("Bussereau" ((NAM 0))())) 
(lex.add.entry '("Butler" ((NAM 0))()))
(lex.add.entry '("Cadbury" ((NAM 0))())) 
...
(lex.add.entry '("Cherki" ((NAM 0))())) 
(lex.add.entry '("Cherpion" ((NAM 0))()))
(lex.add.entry '("Chevrollier" ((NAM 0))())) 
...
(lex.add.entry '("Dordogne" ((NAM 0))())) 
(lex.add.entry '("Douillet" ((NAM 0))()))
(lex.add.entry '("Dubois" ((NAM 0))()))
(lex.add.entry '("Dumas" ((NAM 0))()))
(lex.add.entry '("Dumont" ((NAM 0))())) 
(lex.add.entry '("Duncan" ((NAM 0))()))
(lex.add.entry '("Dupont" ((NAM 0))())) 
(lex.add.entry '("Dupont-Aignan" ((NAM 0))())) 
(lex.add.entry '("Dupont_Aignan" ((NAM 0))())) 
...
(lex.add.entry '("Facebook" ((NAM 0))())) 
(lex.add.entry '("Falls_river" ((NAM 0))())) ;
(lex.add.entry '("Falorni" ((NAM 0))()))
(lex.add.entry '("Far" ((NAM 0))()))
(lex.add.entry '("Far_West" ((NAM 0))()))
(lex.add.entry '("Farragut" ((NAM 0))()))   
...
(lex.add.entry '("Fridriksson" ((NAM 0))())) 
(lex.add.entry '("Fromion" ((NAM 0))()))
(lex.add.entry '("Frédéric" ((NAM 0))()))
(lex.add.entry '("Frédérikson" ((NAM 0))())) 
(lex.add.entry '("Félix" ((NAM 0))())) ; 
(lex.add.entry '("Gad" ((NAM 0))())) 
(lex.add.entry '("Gagnaire" ((NAM 0))())) 
...
(lex.add.entry '("Gosselin" ((NAM 0))())) 
(lex.add.entry '("Gosselin_Fleury" ((NAM 0))())) 
(lex.add.entry '("Goujon" ((NAM -5.014)(NOM -5.716))()))
...
(lex.add.entry '("Guy_Michel" ((NAM 0))())) 
(lex.add.entry '("Guyane" ((NAM 0))()))
(lex.add.entry '("Guéant" ((NAM 0))())) 
...
(lex.add.entry '("Hammadi" ((NAM 0))())) 
(lex.add.entry '("Hamon" ((NAM 0))())) 
(lex.add.entry '("Hans" ((NAM 0))()))  
(lex.add.entry '("Hans" ((NAM 0))())) 
(lex.add.entry '("Harbert" ((NAM 0))()))  
(lex.add.entry '("Harbert" ((NAM 0))())) 
(lex.add.entry '("Harvey" ((NAM 0))()))  
(lex.add.entry '("Harvey" ((NAM 0))())) 
(lex.add.entry '("Hastigt" ((NAM 0))()))   
;(lex.add.entry '("Haute-Garonne" ((NAM 0))())) 
(lex.add.entry '("Haute_Garonne" ((NAM 0))())) 
;(lex.add.entry '("Haute_garonne" ((NAM 0))())) 
(lex.add.entry '("Hautes_Alpes" ((NAM 0))())) 

(lex.add.entry '("Hazebrouck" ((NAM 0))()))
(lex.add.entry '("Heinrich" ((NAM 0))()))
(lex.add.entry '("Helvetia" ((NAM 0))()))
(lex.add.entry '("Henri" ((NAM 0))()))
(lex.add.entry '("Herald" ((NAM 0))()))      
...
(lex.add.entry '("Horeb" ((NAM 0))()))    
(lex.add.entry '("Houillon" ((NAM 0))()))
(lex.add.entry '("Huchon" ((NAM 0))())) 
(lex.add.entry '("Hughe" ((NAM 0))()))
(lex.add.entry '("Hughes" ((NAM 0))())) 
(lex.add.entry '("Hutin" ((NAM 0))())) 
(lex.add.entry '("Huttin" ((NAM 0))())) 
(lex.add.entry '("Hyrcanie" ((NAM 0))())) 
(lex.add.entry '("Hystaspe" ((NAM 0))()))    
...
(lex.add.entry '("Irlande" ((NAM 0))())) 
(lex.add.entry '("Islande" ((NAM 0))()))    
(lex.add.entry '("Israël" ((NAM 0))()))
(lex.add.entry '("Istanbul" ((NAM 0))()))
(lex.add.entry '("Italie" ((NAM 0))())) 
(lex.add.entry '("Itobad" ((NAM 0))()))   
...
(lex.add.entry '("Jean_Sébastien" ((NAM 0))())) 
...
(lex.add.entry '("Jup" ((NAM 0))())) 
(lex.add.entry '("Jupiter" ((NAM 0))()))
(lex.add.entry '("Kaboul" ((NAM 0))()))
(lex.add.entry '("Karoutch" ((NAM 0))())) 
(lex.add.entry '("Keeling" ((NAM 0))())) 
(lex.add.entry '("Kiel" ((NAM 0))()))
(lex.add.entry '("Kobané" ((NAM 0))())) 
(lex.add.entry '("Königstrasse" ((NAM 0))())) 
...
(lex.add.entry '("Launay" ((NAM 0))())) 
(lex.add.entry '("Laurent" ((NAM 0))()))
(lex.add.entry '("Leboeuf" ((NAM 0))())) 
(lex.add.entry '("Lebranchu" ((NAM 0))())) 
(lex.add.entry '("Lefebvre" ((NAM 0))()))
(lex.add.entry '("Lehman" ((NAM 0))()))
(lex.add.entry '("Leipzig" ((NAM 0))()))  
(lex.add.entry '("Leipzig" ((NAM 0))())) ;
(lex.add.entry '("Lellouche" ((NAM 0))()))
(lex.add.entry '("Leonetti" ((NAM 0))())) 
(lex.add.entry '("Lequiller" ((NAM 0))())) ;SIWIS
(lex.add.entry '("Lesage" ((NAM 0))())) 
...
(lex.add.entry '("Martinique" ((NAM 0))())) 
...
(lex.add.entry '("Mencroff" ((NAM 0))()))   
(lex.add.entry '("Mercy" ((NAM 0))())) 
(lex.add.entry '("Meuse" ((NAM 0))())) 
(lex.add.entry '("Michel" ((NAM 0))()))
(lex.add.entry '("Micromégas" ((NAM 0))()))
(lex.add.entry '("Mistour" ((NOM 0))())) 
(lex.add.entry '("Mollac" ((NAM 0))()))
(lex.add.entry '("Monique" ((NAM 0))())) 
(lex.add.entry '("Montebourg" ((NAM 0))())) 
(lex.add.entry '("Morin" ((NAM 0))())) 
...
(lex.add.entry '("N_en" ((ADV -2.384))()))
(lex.add.entry '("Nab" ((NAM 0))()))    
(lex.add.entry '("Nabussan" ((NAM 0))())) 
(lex.add.entry '("Nad" ((NAM 0))())) 
(lex.add.entry '("Nagoya" ((NAM 0))())) 
(lex.add.entry '("Nantes" ((NAM 0))())) 
(lex.add.entry '("Napoléon" ((NAM 0))()))
(lex.add.entry '("Nautilus" ((NAM 0))())) 
...
(lex.add.entry '("Nicole" ((NAM 0))())) 
(lex.add.entry '("Nicolin" ((NAM 0))())) 
(lex.add.entry '("Nil" ((NAM 0))()))
(lex.add.entry '("Norfolk" ((NAM 0))()))
(lex.add.entry '("Nouvelle" ((ADJ -2.415)(NAM -5.014)(NOM -3.607))()))
...
(lex.add.entry '("Peterman" ((NAM 0))())) ;
(lex.add.entry '("Petersburg" ((NAM 0))()))
(lex.add.entry '("Peugeot" ((NAM 0))())) 
...
(lex.add.entry '("Quevilly" ((NAM 0))())) ; 
(lex.add.entry '("Rabin" ((NAM 0))())) 
...
(lex.add.entry '("Rhin" ((NAM 0))())) 
(lex.add.entry '("Rhodes" ((NAM 0))()))
(lex.add.entry '("Rhône-Alpes" ((NAM 0))())) 
...
(lex.add.entry '("Suisse" ((ADJ -4.163)(NAM -2.884)(NOM -5.908))()))
(lex.add.entry '("Tabor" ((NAM 0))())) 
(lex.add.entry '("Tardy" ((NAM 0))())) 
(lex.add.entry '("Thaïlande" ((NAM 0))()))
(lex.add.entry '("Thierry" ((NAM 0))()))
(lex.add.entry '("Thérèse" ((NAM 0))()))
(lex.add.entry '("Tian" ((NAM 0))())) 
...
(lex.add.entry '("Tourret" ((NAM 0))())) 
(lex.add.entry '("Toyota" ((NAM 0))())) 
(lex.add.entry '("Tsukuba" ((NAM 0))()))
(lex.add.entry '("Tyr" ((NAM 0))()))
(lex.add.entry '("USA" ((NAM 0))()))
(lex.add.entry '("Ugues" ((NAM 0))())) 
(lex.add.entry '("Ulysse" ((NAM 0))())) 
(lex.add.entry '("Urville" ((NAM 0))()))
(lex.add.entry '("Valls" ((NAM 0))()))
(lex.add.entry '("Valognes" ((NAM 0))())) 
(lex.add.entry '("Valérie" ((NAM 0))())) 
(lex.add.entry '("Vanikoro" ((NAM 0))()))
(lex.add.entry '("Veran" ((NAM 0))()))
(lex.add.entry '("Vercamer" ((NAM 0))()))
(lex.add.entry '("Verdun" ((NAM 0))())) 
(lex.add.entry '("Vialatte" ((NAM 0))())) 
...
(lex.add.entry '("d_Ameline" ((NAM 0))())) 
(lex.add.entry '("d_Amérique" ((NAM 0))())) 
...
(lex.add.entry '("l_Autriche" ((NAM 0))())) 
(lex.add.entry '("l_Est" ((AUX -0.926)(NAM -2.181)(NOM -4.201)(VER -1.018))()))
(lex.add.entry '("l_Europe" ((NAM 0))()))
(lex.add.entry '("l_Irak" ((NAM 0))()))
(lex.add.entry '("l_Iran" ((NAM 0))()))
(lex.add.entry '("l_Irlande" ((NAM 0))()))
(lex.add.entry '("l_Italie" ((NAM 0))()))
(lex.add.entry '("Olivier" ((NAM -3.462)(NOM -5.357))()))
...
;(lex.add.entry '("Ça" ((PRO:dem -0.614))()))

  ...
  "(french_downcase_string name)
    ...
    (if (not (null? name))
      (begin
        ...
        (set! name (string-replace_utf8 name "À" "à"))
        (set! name (string-replace_utf8 name "Á" "á"))
        (set! name (string-replace_utf8 name "Â" "â"))
        (set! name (string-replace_utf8 name "Ä" "ä"))
        (set! name (string-replace_utf8 name "Å" "å"))
        (set! name (string-replace_utf8 name "Æ" "æ" )) ; ou ae
        (set! name (string-replace_utf8 name "Ç" "ç"))
        (set! name (string-replace_utf8 name "È" "è"))
        (set! name (string-replace_utf8 name "É" "é"))
        (set! name (string-replace_utf8 name "Ê" "ê"))
        (set! name (string-replace_utf8 name "Ë" "ë"))
        (set! name (string-replace_utf8 name "Ì" "ì"))
        (set! name (string-replace_utf8 name "Í" "í"))
        (set! name (string-replace_utf8 name "Î" "î"))
        (set! name (string-replace_utf8 name "Ï" "ï"))
        (set! name (string-replace_utf8 name "Œ" "œ" )); ou oe
        (set! name (string-replace_utf8 name "Ò" "ò"))
        (set! name (string-replace_utf8 name "Ó" "ó"))
        (set! name (string-replace_utf8 name "Ô" "ô"))
        (set! name (string-replace_utf8 name "Ö" "ö"))
        (set! name (string-replace_utf8 name "Ù" "ù"))
        (set! name (string-replace_utf8 name "Ú" "ú"))
        (set! name (string-replace_utf8 name "Û" "û"))
        (set! name (string-replace_utf8 name "Ü" "ü"))
